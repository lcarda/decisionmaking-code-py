...
for i in range(1,7,1):
    ...
    input_file = f"/home/pop/Documents/Carrera/tomacode/decisionmaking-code-py/src/exercises/datos/hierarchical_softmax_game_{i}.json"
    ...
    for row_idx, k_key in enumerate(k_keys):
        for col_idx, lambda_key in enumerate(lambda_keys):
            ...
            ax.set_ylim(0, max(prob_completa) * 0.7)
    ...
    # Guardar figura
    output_path = os.path.join(graficos_dir, f"distribucion_estrategias_h_game_{i}.png")
    plt.savefig(output_path, bbox_inches='tight', dpi=300)
    print(f"\n✅ Gráfico guardado en: {output_path}")

    # Guardar estadísticas
    stats_file = os.path.join(graficos_dir, f"estadisticas_game_h_{i}.json")
